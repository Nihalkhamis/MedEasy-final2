...
/*    myRef.child("2").setValue(new CategoriesModel("Healthy Food","0"));
        myRef.child("3").setValue(new CategoriesModel("Music","1"));
        myRef.child("4").setValue(new CategoriesModel("Yoga","0"));
*/
//
